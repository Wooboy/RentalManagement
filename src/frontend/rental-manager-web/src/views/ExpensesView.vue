<template>
  <div class="card bg-base-100 shadow p-4">
    ...
    <table class="table table-zebra">
      <thead><tr><th>房源</th><th>房間</th><th>類別</th><th>金額</th><th>發生日</th><th></th></tr></thead>
      <tbody>
...
const seed = ()=>({ id:0, propertyUnitId:0, propertyRoomId:0, category:1, billingStartUtc:toDateInput(new Date().toISOString()), billingEndUtc:toDateInput(new Date().toISOString()), amount:0, notes:'', occurredAtUtc:toDateInput(new Date().toISOString()) })
